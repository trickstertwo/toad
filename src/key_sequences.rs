...
impl KeySequenceManager {
    ...
    pub fn vim_defaults() -> Self {
        ...
        manager.register(vec![KeyCode::Char('g'), KeyCode::Char('e')], "goto_end_word");
        manager.register(vec![KeyCode::Char('g'), KeyCode::Char('0')], "goto_line_start");
        manager.register(vec![KeyCode::Char('g'), KeyCode::Char('$')], "goto_line_end");
        ...
        manager.register(vec![KeyCode::Char('d'), KeyCode::Char('$')], "delete_to_end");
        manager.register(vec![KeyCode::Char('d'), KeyCode::Char('0')], "delete_to_start");
        ...
        manager.register(vec![KeyCode::Char('c'), KeyCode::Char('$')], "change_to_end");
        ...
        manager.register(vec![KeyCode::Char('<'), KeyCode::Char('<')], "unindent_line");
        ...
        // Comments
        manager.register(vec![KeyCode::Char('g'), KeyCode::Char('c')], "toggle_comment");
        manager.register(vec![KeyCode::Char('g'), KeyCode::Char('c'), KeyCode::Char('c')], "comment_line");
