...
mod tests {
    ...
    fn test_mode_indicator_with_style() {
        let indicator = ModeIndicator::new(EditorMode::Normal)
            .with_style(IndicatorStyle::Short);
    ...
    fn test_mode_text_short() {
        let indicator = ModeIndicator::new(EditorMode::Insert)
            .with_style(IndicatorStyle::Short);
    ...
    fn test_mode_text_block() {
        let indicator = ModeIndicator::new(EditorMode::Visual)
            .with_style(IndicatorStyle::Block);
