...
impl SmartSuggestions {
    ...
    pub fn with_defaults() -> Self {
        ...
        engine.add_rule(SuggestionRule {
            ...
            priority: 50,
            condition: |ctx| {
                ctx.file_extension.as_deref() == Some("rs")
            },
            generator: |_| {
                vec![
                    Suggestion::new(
...
mod tests {
    ...
    fn test_suggestion_with_icon() {
        let suggestion = Suggestion::new("Test", SuggestionType::Tip, 0.5)
            .with_icon("");
    ...
    fn test_suggestion_with_action() {
        let suggestion = Suggestion::new("Test", SuggestionType::Command, 0.5)
            .with_action("save");
