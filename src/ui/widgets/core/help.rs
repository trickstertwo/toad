...
impl HelpScreen {
    ...
    pub fn render(&self, frame: &mut Frame, area: Rect) {
        ...
        let left_content = vec![
            ...
            self.keybinding_line("Shift+Enter", "Insert newline"),
            self.keybinding_line("Ctrl+u", "Clear input"),
            self.keybinding_line("Ctrl+l", "Clear conversation"),
            self.keybinding_line("Ctrl+Shift+c", "Copy last message"),
        ...
        let right_content = vec![
            ...
            self.keybinding_line("F9", "Evaluation center"),
            self.keybinding_line("F10", "Settings"),
